        ...
        <div className="flex flex-col items-center">
          <div className="flex flex-col items-center mb-4 mt-16">
            <p className="text-3xl font-medium">
              Featured <span className="font-medium text-sc-600">Products</span>
            </p>
            <div className="w-28 h-0.5 bg-sc-600 mt-2"></div>
          </div>
          ...
          <button className="px-8 py-2 mb-16 rounded-xl shadow-lg bg-p-200 text-neu-500 hover:bg-p-100 hover:text-neu-400 hover:shadow-2xl transition">
            See more
          </button>
        </div>
      </div>
